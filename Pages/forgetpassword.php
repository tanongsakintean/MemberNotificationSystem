                ...
                <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                    ...
                    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#">
                        ...
                        <div class="text-center mb-10">
                            <!--begin::Title-->
                            <h1 class="text-dark mb-3">ลืมรหัสผ่านใช่ไหม</h1>
                            <!--end::Title-->
                        </div>
                        <!--begin::Heading-->
                        <!--begin::Input group-->
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <div class="d-flex flex-stack mb-2">
                                <!--begin::Label-->
                                <label class="form-label fw-bolder text-dark fs-6 mb-0">เบอร์โทร</label>
                                <!--end::Label-->
            ...
            methods: {
                Submit($event) {
                    ...
                    if ((this.email != "" && this.tel != "") && this.tel.length == 10) {
                        ...
                        Swal.fire({
                            title: 'เกิดข้อผิดพลาด!',
                            text: 'โปรดกรอกชื่อผู้ใช้งาน หรือ เบอร์โทร ให้ถูกต้อง',
                            icon: 'error',
                            showConfirmButton: false,
                            timer: 1500
                        })
